...
namespace Dravencms\Carousel\DI;
 ...
 * @package Dravencms\Carousel\DI
 */
class CarouselExtension extends Nette\DI\CompilerExtension
{
    ...
    public function loadConfiguration()
    {
        ...
        $builder->addDefinition($this->prefix('carousel'))
            ->setClass('Dravencms\Carousel\Carousel', []);
     ...
     */
    public static function register(Configurator $config, $extensionName = 'carouselExtension')
    {
        $config->onCompile[] = function (Configurator $config, Compiler $compiler) use ($extensionName) {
            $compiler->addExtension($extensionName, new CarouselExtension());
        };
    }
